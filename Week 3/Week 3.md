...
- VN credit-officer job postings (Indeed, HUFLIT article, ...). Supports: the PROBLEM claim only (real demand, skill is the explicit requirement, 2-year experience gate).
